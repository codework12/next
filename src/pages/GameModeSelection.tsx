      ...
      <div className="container relative z-10 px-4 py-16 max-w-7xl">
        ...
        <div className="text-center mb-12 relative">
          <motion.div
            ...
            className="relative"
          >
            <h1 className="orbitron text-5xl md:text-6xl font-bold mb-6 text-glow-intense relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {gameModes.map((mode, index) => (
              ...
              >
                ...
                <Card className="relative h-full border border-primary/30 backdrop-blur-sm bg-background/50 overflow-hidden transition-all duration-300 group-hover:border-primary/60 group-hover:transform group-hover:scale-[1.02]">
                  <CardHeader className="pb-2">
                    <div className="flex justify-between items-start">
                      <h3 className="orbitron text-2xl font-bold text-primary flex items-center gap-2 group-hover:text-glow">
